...
// UserType represents the platform-level authentication account type (Admin vs regular User)
export enum UserType {
  User = 'user',
  Admin = 'admin',
}

// Role represents the application-level access authorization roles (used in RolesGuard)
export enum Role {
  Admin = 'admin',
  Author = 'author',
  Reader = 'reader',
